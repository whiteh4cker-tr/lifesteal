...
import tr.alperendemir.lssmp.Constants;
import tr.alperendemir.lssmp.elimination.EliminationInfo;
import tr.alperendemir.lssmp.feature.heart.BasicElimination;
import tr.alperendemir.lssmp.feature.heart.BasicHeartTake;
...
public class PlayerSelectionHandler implements HelixComponentHandler {
    ...
    private void removeHearts(Player player, double hearts) {
        ...
        var attrib = player.getAttribute(Attribute.MAX_HEALTH);
        assert attrib != null;
